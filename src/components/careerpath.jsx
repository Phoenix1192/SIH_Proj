...
const CareerPathBlock = ({ imagePath, title, description, details }) => {
  return (
  ...
  const careerPaths = [
    {
      ...
      details: 'Career Option: Product Analyst Kind of Work: Analyzing market trends, customer behavior, and product performance to provide insights for product development and improvement. Collaborating with cross-functional teams. Salary: Entry-level: ₹4,00,000 - ₹6,00,000; Mid-career: ₹6,00,000 - ₹8,00,000; Experienced: ₹8,00,000+',
    },
    {
